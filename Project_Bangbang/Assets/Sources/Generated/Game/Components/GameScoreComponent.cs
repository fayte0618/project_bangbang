...
public partial class GameContext {
    ...
    public GameEntity SetScore(int newCurrent) {
        if (hasScore) {
        ...
        entity.AddScore(newCurrent);
        return entity;
    }

    public void ReplaceScore(int newCurrent) {
        var entity = scoreEntity;
        if (entity == null) {
            entity = SetScore(newCurrent);
        } else {
            entity.ReplaceScore(newCurrent);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddScore(int newCurrent) {
