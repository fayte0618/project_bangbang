...
public partial class GameEntity {
    ...
    public void AddCollision(System.Collections.Generic.Dictionary<int, CollisionType> newCurrent) {
    ...
    public void ReplaceCollision(System.Collections.Generic.Dictionary<int, CollisionType> newCurrent) {
        var index = GameComponentsLookup.Collision;
        var component = CreateComponent<CollisionComponent>(index);
        component.current = newCurrent;
