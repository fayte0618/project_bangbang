...
public partial class MetaContext {
    ...
    public MetaEntity SetEntityService(IEntityService newCurrent) {
        if (hasEntityService) {
        ...
        entity.AddEntityService(newCurrent);
        return entity;
    }

    public void ReplaceEntityService(IEntityService newCurrent) {
        var entity = entityServiceEntity;
        if (entity == null) {
            entity = SetEntityService(newCurrent);
        } else {
            entity.ReplaceEntityService(newCurrent);
        }
    }
...
public partial class MetaEntity {
    ...
    public void AddEntityService(IEntityService newCurrent) {
