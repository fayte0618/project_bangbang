...
public partial class MetaContext {
    ...
    public MetaEntity SetInputService(IInputService newCurrent) {
        if (hasInputService) {
        ...
        entity.AddInputService(newCurrent);
        return entity;
    }

    public void ReplaceInputService(IInputService newCurrent) {
        var entity = inputServiceEntity;
        if (entity == null) {
            entity = SetInputService(newCurrent);
        } else {
            entity.ReplaceInputService(newCurrent);
        }
    }
...
public partial class MetaEntity {
    ...
    public void AddInputService(IInputService newCurrent) {
